 ...
 *  INCLUDED FILES: GroceryHashTable.java, Item.java, UserCart.java, DuplicateKeyException.java, 
 *  				IllegalNullKeyException.java, KeyNotFoundException.java
 *  AUTHOR: Anjali Gali
 *  
 *  BEGAN: 3/16/2020
 *  ENDED: 3/22/2020 (in progress)
 *  
 ...
 *  house. Users may also opt to donate items using the donate option. Users can then ship or 
 *  have these items delivered to them, or ship these items to the donation service.
 *  
 *  This project is still in its initial stages. I hope to be able to implement a User Interface 
 *  for this project, so that users can use it on their phones. I would also like to implement this 
 *  as a delivery service where addresses may be stored in a PostGresSQL Database.
 *  
